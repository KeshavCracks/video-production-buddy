...
description: Use for CLI and terminal demo videos where synthetic rendering is better than live capture. Covers Remotion TerminalScene authoring, pacing to narration, and when to use real screen recording instead.
---
...
install_steps = [
    ...
    {"kind": "cmd", "text": "git clone https://github.com/calesthio/Video Production Buddy.git",
     "typeSpeed": 0.045, "holdSeconds": 0.3},
    {"kind": "out", "text": "Cloning into 'Video Production Buddy'..."},
...
cuts.append({
    "id": "install-terminal",
    "type": "terminal_scene",
    "terminalTitle": "bash — Video Production Buddy setup",
    "prompt": "$",
    "accentColor": "#22D3EE",
    "steps": install_steps,
    "in_seconds": 50.0,
