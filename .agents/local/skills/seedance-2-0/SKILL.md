...
| Surface | Env | Video Production Buddy tool | Status | Notes |
|---|---|---|---|---|
| **fal.ai** (primary) | `FAL_KEY` | `seedance_video` | ✅ wrapped | Model IDs below. Supports T2V, I2V, reference-to-video; `standard` and `fast` variants. Default in Video Production Buddy. |
...
## Calling Seedance 2.0 inside Video Production Buddy
...
## Integration notes for Video Production Buddy pipelines
