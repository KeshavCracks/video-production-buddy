...
class TestProvenanceAuditEdgeCases:
    ...
    def test_named_acronym_requires_token_boundary(self) -> None:
        assert not _has_citable_evidence("Reliable data supports this recommendation")

    def test_has_citable_evidence_specific_generic_source_reference(self) -> None:
        assert _has_citable_evidence("The 2025 category report shows 42% higher completion")

    def test_no_evidence_bare_generic_source_reference(self) -> None:
        assert not _has_citable_evidence("The report shows growth")
