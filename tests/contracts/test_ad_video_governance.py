...
def test_decision_log_selected_option_must_be_considered_and_visible_when_approved() -> None:
        ...
        "decisions": [
            {
                ...
                "options_considered": [
                    ...
                    },
                    {
                        ...
                        "label": "HyperFrames",
                        "score": 0.7,
                        "reason": "Available alternative runtime for structured composition.",
                        "rejected_because": "Remotion better fits the approved React scene stack.",
                    }
                ],
                "selected": "remotion",
    ...
    missing_option["decisions"][0]["selected"] = "ffmpeg"
