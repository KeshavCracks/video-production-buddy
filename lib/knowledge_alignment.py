...
def _check_cross_domain_co_presence(
    ...
    for card_id, partner_ids in partners.items():
        ...
        for partner_id in partner_ids:
            ...
            shared_scene_targets = (
                card_targets.intersection(partner_targets).intersection(VISUAL_TARGETS)
            )
            if not shared_scene_targets:
                continue
            ...
            if not co_present_scenes:
                issues.append({
                    ...
                    "shared_targets": sorted(shared_scene_targets),
                    "expected_ref": expected_ref,
