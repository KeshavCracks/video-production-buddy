    ...
    "cards_used": [
      {
        ...
        "principles": [
          "First second shows visible contrast that creates an immediate comprehension gap."
        ],
        ...
        "failure_patterns": [
          "Clickbait contrast unrelated to the product promise."
        ],
        "execution_techniques": [
          "Use a hard cut between before and after so the visual contrast lands cleanly."
        ]
      }
    ],
