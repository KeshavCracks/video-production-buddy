# Scene Detection Usage for Video Production Buddy
...
- Good default for Video Production Buddy explainers where Manim segments are static but live-action may have motion
