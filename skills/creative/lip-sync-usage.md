# Lip Sync Usage for Video Production Buddy

> Sources: Wav2Lip paper (Prajwal et al. 2020), Wav2Lip-GAN documentation, Video Production Buddy
> `tools/avatar/lip_sync.py` implementation
