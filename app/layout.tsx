...
export const metadata: Metadata = {
  ...
  description: 'Plan, approve, generate, compose, and verify videos with a fully transparent, open-source AI production pipeline.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body className="antialiased min-h-screen bg-dark-900 text-white">{children}</body>
    </html>
  );
}
